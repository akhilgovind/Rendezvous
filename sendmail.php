...
$mail->Username = "info@islecaddy.com";  // SMTP username
$mail->Password = "islecaddy"; // SMTP password
$mail->SetFrom('info@islecaddy.com', 'islecaddy');
...
$mail->AddAddress("info@islecaddy.com");                  // name is optional
